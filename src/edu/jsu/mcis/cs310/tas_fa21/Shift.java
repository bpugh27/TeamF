...
public class Shift {
    ...
    Shift(int interval, int shiftID, int gracePeriod, LocalTime shiftStart, int dock, LocalTime lunchStart, int lunchDeduct, LocalTime lunchStop, LocalTime shiftStop, String description) {
